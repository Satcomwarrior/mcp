...
export const getEthBalance: Tool = {
  ...
  handle: async (context: Context, params) => {
    ...
    // Optimization: lazy matchAll combined with early limits avoids full document evaluation
...
export const getEthPairData: Tool = {
  ...
  handle: async (context: Context, params) => {
    ...
    // Optimization: lazy matchAll avoids full evaluation of large texts
...
export const monitorEthTransaction: Tool = {
  ...
  handle: async (context: Context, params) => {
    ...
    // Optimization: lazy matchAll safely avoids full document evaluation for zero-width/large texts
