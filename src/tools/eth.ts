...
export const getDeFiData: Tool = {
  ...
  handle: async (context: Context, params) => {
    ...
    // Performance Optimization: Use lazy matchAll iterators with Sets instead of eager match()
    // full string evaluations and array spreads, maintaining max 5 limits.
