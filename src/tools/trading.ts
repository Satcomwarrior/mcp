...
// Pre-compiled regex for portfolio keywords optimization
const PORTFOLIO_KEYWORDS_REGEX = /(?:balance|equity|position|holdings|portfolio|total|profit|loss|P&L|PnL)/i;
