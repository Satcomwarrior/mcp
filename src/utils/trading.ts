 ...
 * Optimized: Replaced Object.entries loop with direct string character check to prevent unnecessary array allocations
 * Benchmarked: ~3.5x speedup (~2596ms to ~733ms for 4M operations)
 */
